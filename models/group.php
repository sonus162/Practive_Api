<?php
    class Group{
        ...
        public function create(){
            $query ="INSERT INTO `group` SET  `code`=:code,`user_id`=:user_id, `group_name`=:group_name, `kana`=:kana, `admin`=:admin, `user_flg`=:user_flg";
            $stmt=$this->conn->prepare($query);
        ...
        public function update(){
            $query ="UPDATE `group` SET  `code`=:code,`user_id`=:user_id, `group_name`=:group_name, `kana`=:kana, `admin`=:admin, `user_flg`=:user_flg WHERE `id`=:id";
            $stmt=$this->conn->prepare($query);
